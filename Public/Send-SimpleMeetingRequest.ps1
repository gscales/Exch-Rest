...
function  Send-SimpleMeetingRequest {
    param(
    ...
    Begin{
        ...
        New-CalendarEventREST -MailboxName $SenderName -AccessToken $AccessToken -Start $Start -End $End -Subject $Subject -Attendees $Attendees
