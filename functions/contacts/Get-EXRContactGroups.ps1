function Get-EXRContactGroups {
    ...
    Begin {
        ...
        $RequestURL = $EndPoint + "('" + $MailboxName + "')/contacts/?`$Top=1000&`$filter=SingleValueExtendedProperties/Any(ep: ep/Id eq 'String 0x001A' and ep/Value eq 'IPM.DistList')"
        do {
